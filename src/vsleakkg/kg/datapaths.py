...
By default the consolidator auto-detects the v3 repo root from the location of
...
from a different working directory.
    ...
    >>> data_root()
    PosixPath('/vol/.../VS-LeakKG_v3')
    >>> processed_dir()
    PosixPath('/vol/.../VS-LeakKG_v3/data/processed')
"""
...
def data_root() -> Path:
    """Root of the v3 repo (data/, outputs/, src/, ...)."""
